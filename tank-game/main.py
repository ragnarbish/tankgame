...
#gettion sound
fire_sound= pygame.mixer.Sound("Cannon.wav")
explosion_sound= pygame.mixer.Sound("Explosion.wav")
#intro_sound= pygame.mixer.Sound('sound.wav')
...
background_img = pygame.image.load('hills.jpg')
...
def game_contrlos():
	...
	while gcont:
		...
		button('play',(screen_width/2)-300,screen_height-100,100,50, green, light_green, action='p')
		button('main',(screen_width/2)-50,screen_height-100,120,50,yellow, light_yellow, action='m')
		button('quit',(screen_width/2)+200,screen_height-100,100,50, red, light_red, action='q')
...
def game_intro():
	...
	while intro:
		...
		#putting buttons on screen
		button('play',(screen_width/2)-300,screen_height-100,100,50, green, light_green,action='p')
		button('controls',(screen_width/2)-50,screen_height-100,120,50,yellow, light_yellow, action='c')
		button('quit',(screen_width/2)+200,screen_height-100,100,50, red, light_red,action='q')
		pygame.display.update()
		clock.tick(60)
...
def game_over():
	...
	while game_over:
		...
		message_to_screen("You Died", black, -50, size='small')

		# putting buttons on screen
		button('Play Again', (screen_width / 2) - 300, screen_height-100, 150, 50, green, light_green, action='p')
		button('Controls', (screen_width / 2) - 50, screen_height-100, 120, 50, yellow, light_yellow, action='c')
		button('Quit', (screen_width / 2) + 200, screen_height-100, 100, 50, red, light_red, action='q')
...
def you_win():
	...
	while game_over:
		...
		screen.fill(white)
		message_to_screen("You Win", green, -100, size='medium')
		message_to_screen("Congrulations", black, -50, size='small')
			...
			if event.type == pygame.KEYDOWN:
				if event.key == pygame.K_LEFT:
					...
					for x in range(random.randrange(0,10)):
						if screen_width *3 > enemyTankX > screen_width * 0.03:
